...
(cl:defmethod cl:initialize-instance :after ((m <State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name buggy_robot-msg:<State> is deprecated: use buggy_robot-msg:State instead.")))

(cl:ensure-generic-function 'stamp-val :lambda-list '(m))
(cl:defmethod stamp-val ((m <State>))
...
(cl:defmethod x-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buggy_robot-msg:x-val is deprecated.  Use buggy_robot-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'x_dot-val :lambda-list '(m))
(cl:defmethod x_dot-val ((m <State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader buggy_robot-msg:x_dot-val is deprecated.  Use buggy_robot-msg:x_dot instead.")
  (x_dot m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<State>)))
  ...
  "3f7c1e71ff724a5e596d059e9f465816")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'State)))
  "Returns md5sum for a message object of type 'State"
  "3f7c1e71ff724a5e596d059e9f465816")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<State>)))
  "Returns full string definition for message of type '<State>"
  (cl:format cl:nil "std_msgs/Time stamp~%float64 x~%float64 x_dot~%================================================================================~%MSG: std_msgs/Time~%time data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'State)))
  "Returns full string definition for message of type 'State"
  (cl:format cl:nil "std_msgs/Time stamp~%float64 x~%float64 x_dot~%================================================================================~%MSG: std_msgs/Time~%time data~%~%~%"))
